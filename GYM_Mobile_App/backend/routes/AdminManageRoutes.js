...
router.patch('/admin-manage-change-approve-for-user/:userId/:adminId', AdminManageController.AdminManage_ChangeApproveForUser);
router.patch('/admin-manage-change-approve-for-gym/:gymId/:adminId', AdminManageController.AdminManage_ChangeApproveForGym);
router.patch('/admin-manage-change-approve-for-coach/:coachId/:adminId', AdminManageController.AdminManage_ChangeApproveForCoach);
router.patch('/admin-manage-change-approve-for-admin/:adminId/:adminId2', AdminManageController.AdminManage_ChangeApproveForAdmin);
...
router.delete('/admin-manage-delete-user/:userId/:adminId', AdminManageController.AdminManage_DeleteUser);
router.delete('/admin-manage-delete-gym/:gymId/:adminId', AdminManageController.AdminManage_DeleteGym);
router.delete('/admin-manage-delete-coach/:coachId/:adminId', AdminManageController.AdminManage_DeleteCoach);
router.delete('/admin-manage-delete-admin/:adminId/:adminId2', AdminManageController.AdminManage_DeleteAdmin);
