...
router.patch('/gym-post-fasilities-delete/:gymPostId', GymPostController.deleteGymFasilities);
...
router.patch('/gym-post-delete-package/:gymPostId', GymPostController.deleteGymPackages);
...
router.get('/gym-post-get-by-gym-id/:gymId', GymPostController.getGymPostDetailsByGymPostId);
router.get('/gym-post-get-all', GymPostController.getGymPostByGymId);
